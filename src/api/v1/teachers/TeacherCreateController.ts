...
import { FindTeacherResponseDTO, TeacherDTO } from "./dto/teacher.dto";
...
export class TeacherCreateController{
    ...
    @Post('api/v1/teacher')
    async execute(@Body() teacher: TeacherDTO): Promise<FindTeacherResponseDTO | HttpStatus.INTERNAL_SERVER_ERROR>{
